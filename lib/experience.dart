              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      padding: const EdgeInsets.only(top: 5, bottom: 62),
                      child: Card(
                        child: Container(
...
class _AddExperiencePageState extends State<AddExperiencePage> {
  ...
  List<String> positions = ['Professor', 'Developer', 'Intern', 'HR'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Add new experience', style: GoogleFonts.comfortaa(fontWeight: FontWeight.bold),),
      ),
      body: Padding(
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (toDate.isBefore(fromDate)) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('The beginning date cannot be greater than the end date'),
