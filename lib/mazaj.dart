...
class Mazaj extends StatefulWidget {
  const Mazaj({Key? key}) : super(key: key);

  @override
  State<Mazaj> createState() => _MazajState();
}
...
class _MazajState extends State<Mazaj> {
          ...
          children: [
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Text(
                    'Mazaj \nRestaurant',
                    style: GoogleFonts.mukta(textStyle: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
                  ),
                ),
                const Spacer(),
                Container(
                ...
                const Row(
                  children: [
                    Padding(
                      padding: EdgeInsets.only(left: 25),
                      child: Text(
                        'The idea was simple; provide a comfortable and \nunique place to escape from the stress of everyda...',
            ...
            Align(
              ...
              child: TextButton.icon(
                onPressed: () {
                  context;
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const BuddiesPage())
                  );
                },
                label: const Text(
                  'Invite buddy',
