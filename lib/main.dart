...
import 'package:hookapp/profile.dart';
import 'package:hookapp/restaurant.dart';
...
Future<void> main() async {
  ...
  await Hive.openBox<Product>('productsBox2');
...
class _MenuScreenState extends State<MenuScreen> {
  ...
  final List<ListItems> drawerItems = [
    ...
    ListItems(
      Icon(Icons.fact_check_outlined, color: Colors.yellow.shade600),
      const Text('Checkout'),
    ...
    ListItems(
      Icon(Icons.calendar_today_rounded, color: Colors.yellow.shade600),
    ...
    ListItems(
      Icon(Icons.mail, color: Colors.yellow.shade600),
