...
import 'package:hookapp/buddies.dart';
import 'package:url_launcher/url_launcher.dart';

class Savoia extends StatefulWidget {
  const Savoia({Key? key}) : super(key: key);

  @override
  State<Savoia> createState() => _SavoiaState();
}
...
class _SavoiaState extends State<Savoia> {
                ...
                const Row(
                  children: [
                    Padding(
                      padding: EdgeInsets.only(left: 25),
                      child: Text(
                        'Savoia Resto Pub & Lounge Zahle Coffee Shop \nResto-Night Club',
